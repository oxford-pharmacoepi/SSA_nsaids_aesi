...
summary_temp_trends_months_controls <- 
  list(summariseTemporalSymmetry(cohort = cdm[["amiodarone_levothyroxine"]]
       ...
       summariseTemporalSymmetry(cohort = cdm[["amiodarone_allopurinol"]]
                                 , timescale = "month"),
       summariseTemporalSymmetry(cohort = cdm[["all_nsaids_edema"]]
                                 , timescale = "month"),
       summariseTemporalSymmetry(cohort = cdm[["all_nsaids_nausea"]]
                                 , timescale = "month"),
       summariseTemporalSymmetry(cohort = cdm[["all_nsaids_vomiting"]]
                                 , timescale = "month"),
       summariseTemporalSymmetry(cohort = cdm[["all_nsaids_aki"]]
                                 , timescale = "month"),
       summariseTemporalSymmetry(cohort = cdm[["all_nsaids_anemia"]]
                                 , timescale = "month"),
       summariseTemporalSymmetry(cohort = cdm[["all_nsaids_cataracts"]]
                                 , timescale = "month")
  ) %>% 
  bind()
